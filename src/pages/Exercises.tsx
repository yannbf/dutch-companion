...
import { GraduationCap, BookOpen, FileText, Shuffle, CloudSun } from "lucide-react";
...
const Exercises = () => {
  ...
  const exercises = [
    ...
    },
    {
      id: "weather",
      title: "Weather",
      description: "Learn weather words and classify sentence sentiment",
      icon: CloudSun,
      path: "/exercises/weather",
    },
  ];
